  ...
  return (
    <div>
      ...
      <div className="absolute">
        <img
        className="h-screen md:h-fit object-cover"
          src={BG_URL}
          alt="logo"
        />
      </div>
      <form
        ...
        className=" w-[95%] md:w-3/12 absolute p-12 bg-black my-36 mx-auto left-0 right-0 text-white rounded-lg bg-opacity-80">
